  ...
  Widget buildOtp(double height, SignUpVM model) {
    return Column(
      ...
      children: [
        ...
        BTN(margin: EdgeInsets.only(top:height*3), children: [Expanded(child: TEXT(text: 'Verify', color: Colors.black, fontWeight: FontWeight.bold, textAlign: TextAlign.center, edgeInset: EdgeInsets.all(0.0),)),
        SizedBox(
          height: 18,
          width: 18,
